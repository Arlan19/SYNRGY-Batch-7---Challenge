...
//    private static final String SECURED_PATTERN = "/api/**";
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatcher("/**")
                .authorizeRequests()
                .antMatchers("/","/showFile/**","/v1/showFile/**","/v1/upload", "/user-register/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/user-login/**","/user_login/**",
                        "/forget-password/**", "/oauth/authorize**", "/login**", "/error**", "/v1/user-register/**", "/v1/forget-password/**", "/register", "/register/**")
                .permitAll()
