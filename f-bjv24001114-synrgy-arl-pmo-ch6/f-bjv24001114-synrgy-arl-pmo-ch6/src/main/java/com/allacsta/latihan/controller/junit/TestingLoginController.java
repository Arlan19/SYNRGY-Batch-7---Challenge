package com.allacsta.latihan.controller.junit;
...
public class TestingLoginController {
    ...
    public void restTemplateLogin2() throws Exception {
        ...
        ResponseEntity<String> exchange = restTemplate.exchange("http://localhost:8080/api/user-login/login", HttpMethod.POST, entity, String.class);
